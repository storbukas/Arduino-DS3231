 ...
 *  DS3231.h
 *
 *  Header file for the DS3231 Real-Time Clock
 *
 *  created 03 Feb 2021
...
class DS3231 {
 public:
  ...
  void setAlarm1(uint8_t dydw, uint8_t hour, uint8_t minute, uint8_t second,
                 DS3231_alarm1_t mode, bool armed = true);
  ...
  void setAlarm2(uint8_t dydw, uint8_t hour, uint8_t minute,
                 DS3231_alarm2_t mode, bool armed = true);
 ...
 private:
  ...
  long time2long(uint16_t days, uint8_t hours, uint8_t minutes,
                 uint8_t seconds);
